...
?>
<a style="float:right;" href="#" onclick="closeTab('<?php echo $this->data['User']['id'];?>');return false;"><img src="/admin_theme/cross_grey_small.png" alt="Add"></a>
<!--<h4 style="text-align: right;">Edit User</h4> <hr />-->
<?php 
	...
	echo $this->Form->create(null, array(
		'url' => '/admin/users/edit/'.$this->data['User']['id'],
		'inputDefaults' => array(
            'label' => false,
            'div' => false,
...
?>	
	<fieldset>                                                          
			...
			<?php
				echo $this->Form->input('password',array('class'=>'text-input small-input','value'=>''));
			?>
			</div>
			<div class="form_input">
			<label>Confirm Password</label>
			<?php
				echo $this->Form->input('cpassword',array('class'=>'text-input small-input','type'=>'password','value'=>''));
			?>
			</div>
			<div class="form_input">
			<label>Email</label>
			...
			<?php
				echo $this->Js->submit('Save', array(
					'update' => '#tabc_'.$this->data['User']['id'], 
					'div' => false, 
					'type' => 'post', 
					'async' => false,
