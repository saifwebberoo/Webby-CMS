...
<a style="float:right;" href="#" onclick="ckeditor_close_<?php echo $this->data['Form']['id'];?>(); closeTab('<?php echo $this->data['Form']['id'];?>');return false;"><img src="/admin_theme/cross_grey_small.png" alt="Add"></a>
<?php 
	...
	echo $this->Form->create(null, array(
		'url' => '/admin/forms/edit/'.$this->data['Form']['id'],
		'inputDefaults' => array(
            'label' => false,
            'div' => false,
...
?>	
	<fieldset>  
		...
		<?php
		echo $this->Form->input('content',array('class'=>'ckeditor','label'=>false,'id'=>'frm_content_'.$this->data['Form']['id']));
		?>
		</div>
		...
		<?php
		echo $this->Form->input('successmsg',array('id'=>'successmsg_'.$this->data['Form']['id'],'style'=>'width:350px;','label'=>false,'default'=>'Saved Successfully'));
		?>
		</div>
		...
		<?php
		echo $this->Form->input('response_content',array('id'=>'response_content_'.$this->data['Form']['id']));
		?>
		<a href="#" id="editori" class="fr" onclick ="toggleEditor('response_content',$(this));return false;">Switch To Html</a>
		</div>
...
<script type="text/javascript">
	$( '#frm_content_<?php echo $this->data['Form']['id']?>, #response_content_<?php echo $this->data['Form']['id']?>' ).ckeditor( function() { /* callback code */ }, { toolbar : 'FormBuilder', } );
	function ckeditor_close_<?php echo $this->data['Form']['id'];?>(){
		CKEDITOR.instances.frm_content_<?php echo $this->data['Form']['id']?>.destroy();
		CKEDITOR.instances.response_content_<?php echo $this->data['Form']['id']?>.destroy();
	}
</script>
<?php
echo $this->TinyMce->init('successmsg_'.$this->data['Form']['id']);
